...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton myBroadcastBnt;
    private ImageButton receiveSMSBroadcastBnt;
    private ImageButton handleBnt;
    private ImageButton advertiseBnt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handleBnt =(ImageButton) findViewById(R.id.handleBnt);
        handleBnt.setOnClickListener(buttonOnClickListener);

        advertiseBnt =(ImageButton) findViewById(R.id.advertiseBnt);
        advertiseBnt.setOnClickListener(buttonOnClickListener);
    }
    //定义事件监听的处理逻辑
                ...
                public void onClick(View view) {
                    ...
                    switch(view.getId()){
                        ...
                        case R.id.receiveSMSBroadcastBnt: //为接受系统短信广播，动态设置权限
                            ...
                            break;
                        case R.id.handleBnt: //演示Handle
                            intent.setClass(MainActivity.this, HandleDemoActivity.class);
                            startActivity(intent);
                            break;
                        case R.id.advertiseBnt: //轮播广告图片

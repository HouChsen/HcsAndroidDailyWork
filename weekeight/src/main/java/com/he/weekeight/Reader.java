...
public class Reader {
    ...
    public Reader(String reader_number,String reader_name,String reader_type,String reader_phone,String reader_password,String reader_createtime){
    ...
    public void setReader_type(String reader_name){
        this.reader_type=reader_type;
    }
    ...
    public void setReader_createtime(String reader_createtime){this.reader_createtime=reader_createtime;}

    @Override
    public String toString() {
        return "读者{" + "编号：" + reader_number + "；姓名：" + reader_name + "；类别" + reader_type + "；电话" + reader_phone + "}\n";

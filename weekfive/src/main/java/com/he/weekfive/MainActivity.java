...
public class MainActivity extends AppCompatActivity {
    ...
    //校徽数组（图片及文字）
    private int[] flag = {R.drawable.ytu_200, R.drawable.pku_200, R.drawable.tsinghua_200};
    ...
    //为操作学校 Logo 的大小，需要定义对应 ImageView 组件
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        c = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));    //获取东八区时间
...
//处理“上一页”
                    if (currentPage == 0) {
                        //Toast.makeText(MainActivity.this, "第一页，前面没有了",
...
//在第一轮改造程序并运行体验对话框后，在此处加入附后的代码继续检验
                        builder.create()
                                .show();
...
//处理“下一页”
                    if (currentPage == (flag.length - 1)) {
                        Toast.makeText(MainActivity.this, "最后一页，后面没有了",
                                Toast.LENGTH_SHORT).show();
                        return;
                    }
//下翻一页
                            ...
                            .setSingleChoiceItems(universityNames, //选项来自universityNames 数组
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            myUniversity =
                                                    universityNames[which].toString();
                                        }
                                    })
...
//在下面体验选择时间的对话框
    ...
    //定义复合按钮事件监听对象，设置处理逻辑
    private CompoundButton.OnCheckedChangeListener onCompoundButtonOnCheckedChange
...
//设置小 Logo
                ...
                universityImageView.setLayoutParams(params);
                    ...
                    break;
                case R.id.dateTimeToggleBnt:
//响应日期时间是否可见
                    if(checked){
                        dateLayout.setVisibility(View.VISIBLE);
                        timeLayout.setVisibility(View.VISIBLE);
//setVisibility()有三个参数：VISIBLE, INVISIBLE, or GONE
//VISIBLE:0 意思是可见的
